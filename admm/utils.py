...
def difference_params(model1_params, model2_params):
    """
    calculated the difference of the parameters of model2 from model1
    """
    # Initialize difference as zeros like input parameters
    diff = [torch.zeros_like(param) for param in model1_params]
    for param1, param2 in zip(model1_params, model2_params):
        diff = param1 - param2
    return diff